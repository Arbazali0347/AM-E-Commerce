...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] bordert'>
      {/* --------------------- Left Side ------------------- */}
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input required onChange={onChangeHandler} name="address" value={formData.address} className='border border-gray-500 rounded py-1.5 px-3.5 w-full' type="text" placeholder='address & house number' />
        <div className='flex gap-3'>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          {/* ___________________ text payment seletion*/}
          ...
          <div className='w-full text-end mt-8'>
            <button type='submit' className='cursor-pointer bg-black text-white px-16 py-3 text-sm'>{loading ? "Loading..." : "PLACE ORDER"}</button>
          </div>
        </div>
      </div>
    </form>
