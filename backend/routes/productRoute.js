...
import {listProduct, addProduct, removeProduct, singleProduct, updateProduct, getSingleProduct, } from "../controllers/productController.js"
...
productRoute.post("/update/:id", adminAuth, updateProduct);
